...
namespace Clinic
{
    public class ClinicConstant
    {
        ...
        public const string HistoryTable_NameDoctor = "NameDoctor";
        public const string HistoryTable_NameLoaiKham = "NameLoaiKham";
        ...
        public const string PatientTable_Name = "Name";
        ...
        public const string StringLabelIdMainForm = "ID\r\n";


        public const string MainFormSettings_FileName = "MainFormSettings.xml";
        public const string Categories_FileName = "Categories.xml";
    }
}
