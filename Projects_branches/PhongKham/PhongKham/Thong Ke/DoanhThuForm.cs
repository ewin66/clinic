...
namespace Clinic
{
    ...
    public partial class DoanhThuForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e) // ngay
        {
            ...
            listItem = Clinic.Thong_Ke.HelperThongKe.GetDoanhThuFromHistory(dateTimePicker1.Value,DaysFormat.Ngay);
             FillToGrid(listItem);
             CalcuTotal();
        }
        ...
        {
            dataGridViewMain.Rows.Clear();
            listItem = Clinic.Thong_Ke.HelperThongKe.GetDoanhThuFromHistory(dateTimePicker1.Value, DaysFormat.Thang);
            FillToGrid(listItem);
            CalcuTotal();
        }
