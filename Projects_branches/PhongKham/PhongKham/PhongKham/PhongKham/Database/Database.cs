...
namespace Clinic.Database
{
        ...
        where TDbConnectionStringBuilder : DbConnectionStringBuilder
    {
        ...
        private void UpdateDatabase(string password)
        {
            ...
            fun = () => ExecuteNonQuery("ALTER TABLE history  ADD COLUMN " + ClinicConstant.HistoryTable_NameDoctor + " TEXT NULL ;", null);
            Guard(fun);


            fun = () => ExecuteNonQuery("ALTER TABLE history  ADD COLUMN " + ClinicConstant.HistoryTable_NameLoaiKham + " TEXT NULL ;", null);
            Guard(fun);

            fun = () => ExecuteNonQuery("SET GLOBAL event_scheduler = ON;", null);
            Guard(fun);
