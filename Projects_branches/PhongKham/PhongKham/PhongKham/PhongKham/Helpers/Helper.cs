...
namespace Clinic.Helpers
{
    ...
    public class Helper
    {
        ...
        public static List<string> ColumnsHistory = new List<string>() { "Id", "Symptom", "Diagnose", "Day", "Medicines", "temperature", "huyetap", ClinicConstant.HistoryTable_NameDoctor, ClinicConstant.HistoryTable_NameLoaiKham, ClinicConstant.HistoryTable_Reason };
        #endregion
    ...
    List<string> values, string id, string Username)
        ...
        {
            Logger.Log("checkAdminExists", "Begin");
            try
            {
                string strCommand = "SELECT * FROM " + nameOfTable + " WHERE Authority = 1";
                // MySqlCommand comm = new MySqlCommand(strCommand, conn);
                ...
                bool hasrow = false;
                using (DbDataReader reader = (DbDataReader)db.ExecuteReader(strCommand, null))
                {
            ...
            {
                Logger.Log("checkAdminExists", ex.Message);
        ...
        //    }
        //}
        internal static int SearchMaxValueOfTable(IDatabase db, string table, string nameOfColumn, string order)
        {
